...
function addTest($connection, 
	...
	$query = "INSERT INTO innodb.test (UUID, TEST_ID, CLIENT_IP, TEST_TIME, PLATFORM, VENDOR, HIT_CODE, H1_LATENCY, H1_LAT_ERR, H1_BANDWIDTH, H1_BW_ERR, H1_SUCCESSIVE_LARGE, H1_SUCCESSIVE_LARGE_ERR, H1_SUCCESSIVE_LARGE_TOTAL_TIME, H1_CONCURRENT_LARGE, H1_CONCURRENT_LARGE_ERR, H1_CONCURRENT_LARGE_TOTAL_TIME, H1_SUCCESSIVE_SMALL, H1_SUCCESSIVE_SMALL_ERR, H1_SUCCESSIVE_SMALL_TOTAL_TIME, H1_CONCURRENT_SMALL, H1_CONCURRENT_SMALL_ERR, H1_CONCURRENT_SMALL_TOTAL_TIME, H2_LATENCY, H2_LAT_ERR, H2_BANDWIDTH, H2_BW_ERR, H2_SUCCESSIVE_LARGE, H2_SUCCESSIVE_LARGE_ERR, H2_SUCCESSIVE_LARGE_TOTAL_TIME, H2_CONCURRENT_LARGE, H2_CONCURRENT_LARGE_ERR, H2_CONCURRENT_LARGE_TOTAL_TIME, H2_SUCCESSIVE_SMALL, H2_SUCCESSIVE_SMALL_ERR, H2_SUCCESSIVE_SMALL_TOTAL_TIME, H2_CONCURRENT_SMALL, H2_CONCURRENT_SMALL_ERR, H2_CONCURRENT_SMALL_TOTAL_TIME) VALUES ('$u', '$ti', '$eyep', '$tt', '$p', '$v', '$hc', '$h1l', '$h1le', '$h1b', '$h1be', '$h1sl', '$h1sle', '$h1sltt', '$h1cl', '$h1cle', '$h1cltt', '$h1ss', '$h1sse', '$h1sstt', '$h1cs', '$h1cse', '$h1cstt', '$h2l', '$h2le', '$h2b', '$h2be', '$h2sl', '$h2sle', '$h2sltt', '$h2cl', '$h2cle', '$h2cltt', '$h2ss', '$h2sse', '$h2sstt', '$h2cs', '$h2cse', '$h2cstt');";
