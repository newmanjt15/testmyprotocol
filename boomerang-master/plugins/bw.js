...
(function() {
	...
	impl = {
		...
		img_loaded: function(i, tstart, run, success) {
            ...
            //jtn - don't check this so we can do multiple runs
	...
	BOOMR.plugins.BW = {
		...
		run: function(numberRuns = 0, http_version = "h2") {
			var a;
            ...
            if (http_version === "h2"){
                ...
                a.href = "http://www.testmyprotocol.com/boomerang-master/images/";
            }
            console.log(a.href);
			...
			impl.aborted = false;
			if(numberRuns != 0){
				impl.runs_left = numberRuns;
				impl.nruns = numberRuns;
			}
